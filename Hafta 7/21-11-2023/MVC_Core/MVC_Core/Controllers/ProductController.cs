...
namespace MVC_Core.Controllers
{
    public class ProductController : Controller
    {
        ...
        {
            Product productToUpdate = _productContext.Products.FirstOrDefault(x => x.ProductID == product.ProductID);
        ...
        [HttpPost]
        public IActionResult HocaUpdate(Product product)
        {
            _productContext.Entry(product).State = EntityState.Modified;
