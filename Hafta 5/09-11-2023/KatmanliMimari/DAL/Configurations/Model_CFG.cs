...
{
    public class Model_CFG : IEntityTypeConfiguration<Model>
    {
        public void Configure(EntityTypeBuilder<Model> builder)
        {
            ...
            builder.Property(x => x.ModelYili)
            ...
            builder.HasData(
                ...
                new Model { ModelID = 6, MarkaID = 3, ModelAdi = "Serce", ModelYili = 1999},
                new Model { ModelID = 7, MarkaID = 3, ModelAdi = "Dogan", ModelYili = 1985}
                );
        }
    }
}
