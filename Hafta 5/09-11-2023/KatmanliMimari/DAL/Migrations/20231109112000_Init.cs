        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MODEL_ID = table.Column<int>(type: "NUMBER(10)", nullable: false)
                        .Annotation("Oracle:Identity", "START WITH 10 INCREMENT BY 1"),
                    MODEL_ADI = table.Column<string>(type: "NVARCHAR2(15)", maxLength: 15, nullable: false),
                    MODEL_YILI = table.Column<int>(type: "NUMBER(10)", maxLength: 5, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PLAKA = table.Column<string>(type: "CHAR(8)", maxLength: 8, nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "MARKALAR",
                columns: new[] { "MARKA_ID", "MARKA_ADI" },
                values: new object[] { 2, "Volkswagen" });
